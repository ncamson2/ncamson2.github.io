...
class AcceptedOffersDisplay extends StatelessWidget {
  // final String categoryType;
  const AcceptedOffersDisplay({
    super.key,
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          final currentUserBidDataDisplayed = currentUserBidList
              .where((offer) => offer['isAccepted'] == true)
              .toList();
              ...
              itemBuilder: (context, index) {
                return BlocBuilder<CurrentUserPostCubit, CurrentUserPostState>(
                  builder: (context, state) {
                    context.read<CurrentUserPostCubit>().acceptedOfferLength(
                        acceptedOfferLength:
                            currentUserBidDataDisplayed.length);
                    print(currentUserBidDataDisplayed.length.toString() +
                        'Nicholas');
